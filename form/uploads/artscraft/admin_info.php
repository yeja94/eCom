...
<div id="portfolio">
    <div class="text-center">	
        ...
        <div class="col-lg-12 text-center">
            ...
            <a href="artscraft.php"><button class="btn">Art&Craft</button></a>
            ...
            <a href="<?php echo $sitepath;?>form/uploads/household/admin_info.php"><button class="btn">Household</button></a>
